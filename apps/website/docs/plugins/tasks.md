...
See [plugins/clio-plugin-tasks/src/extensions/clio-plugin-tasks-jira](https://github.com/archubbuck/cli-ops/tree/main/plugins/clio-plugin-tasks/src/extensions/clio-plugin-tasks-jira) for implementation example.
