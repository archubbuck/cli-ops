...
**Clio** is a modern, plugin-first CLI framework designed for building extensible command-line tools with exceptional user experience.
...
Clio uses [oclif's plugin system](https://oclif.io/docs/plugins) to enable modular functionality:
...
<div className="row">
  <div className="col col--6">
    <div className="card">
      ...
      <div className="card__body">
        <p>Get started with installation and core concepts</p>
      </div>
      <div className="card__footer">
        <a href="/docs/installation" className="button button--primary button--block">Install Clio</a>
      </div>
    </div>
  </div>
  ...
  <div className="col col--6">
    <div className="card">
      ...
      <div className="card__body">
        <p>Create your own clio plugin in minutes</p>
      </div>
      <div className="card__footer">
        <a href="/docs/plugins/getting-started" className="button button--primary button--block">Plugin Guide</a>
      </div>
    </div>
  </div>
</div>
