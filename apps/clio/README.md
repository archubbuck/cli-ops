...
```bash
clio setup                    # Interactive setup for shell completions
clio autocomplete bash        # Generate bash completions
clio autocomplete zsh         # Generate zsh completions
clio autocomplete fish        # Generate fish completions
clio autocomplete powershell  # Generate PowerShell completions
```

Shell completions are automatically refreshed when plugins are installed or uninstalled.
