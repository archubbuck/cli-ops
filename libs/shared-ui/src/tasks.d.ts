 ...
 */
export declare function createTaskList<TContext = unknown>(
  tasks: Task<TContext>[],
  options?: TaskListOptions,
): TaskList<TContext>
/**
 ...
 */
export declare function createSequentialTasks<TContext = unknown>(
  tasks: Task<TContext>[],
 ...
 */
export declare function createConcurrentTasks<TContext = unknown>(
  tasks: Task<TContext>[],
  options?: Omit<TaskListOptions, 'concurrent'>,
): TaskList<TContext>
/**
 ...
 */
export declare function runTask<T>(
  title: string,
  fn: () => Promise<T>,
  options?: TaskListOptions,
): Promise<T>
