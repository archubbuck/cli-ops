 ...
 */
export declare function withProgressBar<T>(total: number, fn: (bar: ProgressBar) => Promise<T>, options?: Omit<ProgressBarOptions, 'total'>): Promise<T>;
/**
 * Track progress of array processing
 */
export declare function processWithProgress<T, R>(items: T[], processor: (item: T, index: number) => Promise<R>, options?: Omit<ProgressBarOptions, 'total'>): Promise<R[]>;
