...
See [Extension Plugins Guide](/docs/guides/extension-plugins) for more details on creating extensions.

## See Also

- [Configuration Reference](/docs/guides/configuration) - HTTP and caching configuration
- [Plugin Development](/docs/contributing/plugin-development) - Creating plugins
- [Tasks Plugin](./tasks) - Task management
- [Repo Plugin](./repo) - Git/GitHub integration
