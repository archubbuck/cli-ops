...
[Learn more →](../plugins/repo)

## Next Steps

- [Develop Your Own Plugin](/docs/contributing/plugin-development)
- [Plugin Best Practices](/docs/contributing/plugin-best-practices)
- [Extension Plugins](./extension-plugins) - Extend existing plugins
