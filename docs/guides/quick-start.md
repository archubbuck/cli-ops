...
2. **Enable shell completions** for faster command entry: `clio setup`
...
- [Core Concepts](./concepts) - Learn about plugins, commands, and configuration
- [Plugin Guide](./plugins-getting-started) - Discover and install plugins
- [Architecture Overview](/docs/architecture/overview) - Understand how Clio works internally
