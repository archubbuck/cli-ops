...
| -------- | ------- | -------- | -------------------------- | ----------- | --------------- |
| **clio** | 1.0.0   | 7        | ⚠️ 730ms / ⚠️ 725ms        | ❌ No tests | 0               |
| **clio** | 3.0.0   | 2        | ⚠️ 580ms / ⚠️ 574ms        | ❌ No tests | 0               |
| **clio** | 3.0.0   | 1        | ❌ / ❌                    | ❌ No tests | 0               |
| **clio** | 3.0.0   | 3        | ⚠️ 577ms / ⚠️ 575ms        | ❌ No tests | 0               |
| **clio** | 3.0.0   | 1        | ❌ / ❌                    | ❌ No tests | 0               |
| **clio** | 3.0.0   | 5        | ⚠️ 668ms / ⚠️ 660ms        | ❌ No tests | 0               |
...
| ----------- | -------- | ------ | -------------- |
| `--help`    | 730ms    | 500ms  | ⚠️ Over Budget |
| `--version` | 725ms    | 200ms  | ⚠️ Over Budget |
...
| `--version` | 574ms    | 200ms  | ⚠️ Over Budget |
...
| `--version` | 660ms    | 200ms  | ⚠️ Over Budget |
