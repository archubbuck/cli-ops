---
sidebar_position: 2
sidebar_label: 'ADR-002: Changesets for Versioning'
title: 'ADR-002: Use Changesets for Independent Package Versioning'
description: 'Decision to use Changesets for independent package versioning, changelog generation, and semantic versioning'
---
