...
'@cli-ops/clio-plugin-tasks-jira': major
'@cli-ops/clio-plugin-fetch-oauth': major
'@cli-ops/clio-plugin-repo-hooks': major
---

**BREAKING CHANGE**: Extension plugins refactored to top-level architecture (v3.0.0)
